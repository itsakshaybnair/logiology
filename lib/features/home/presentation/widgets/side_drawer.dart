...
import 'package:logiology/features/home/presentation/widgets/edit_user_info_dialog.dart';
...
class _SideDrawerState extends State<SideDrawer> {
  ...
  void selectImage() async {
    ...
    if (pickedImage != null) {
      ...
      await UserPreferences.setUserDP(
        dP: pickedImage.path,
      );
      UserInfo.dP = pickedImage.path;
              ...
              children: [
                ...
                Column(
                  children: [
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap: () => selectImage(),
                            child: Container(
                              padding:  EdgeInsets.all(context.setResponsiveSize(1.5, 1.5)),
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                    ...
                    Padding(
                      padding:  EdgeInsets.only(left: context.setResponsiveSize(9, 8), top: context.setResponsiveSize(6, 6)),
...
scrollDirection: Axis.horizontal,
                        child: Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: () {
                                _editUserInfoDialog(context, true, UserInfo.name);
                              },
                              child: Icon(
                                Icons.edit,
                ...
                Container(
                  margin:  EdgeInsets.symmetric(horizontal: context.setResponsiveSize(6, 6)),
                  padding:
                      const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
                  decoration: BoxDecoration(
                    color: Colors.grey[100],
                    borderRadius: BorderRadius.circular(context.setResponsiveSize(6, 6)),
                    boxShadow: [
                      BoxShadow(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.lock_outline, size: context.setResponsiveSize(6, 6), color: AppColors.greyColor),
                        SizedBox(width: context.setResponsiveSize(3, 2)),
                        SizedBox(
                         // width: context.setResponsiveSize(60, 55),
                          child: Row(
                            children: [
                              Text(
                                UserInfo.paswword,
