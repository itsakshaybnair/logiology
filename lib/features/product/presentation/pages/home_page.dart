...
import 'package:logiology/features/product/presentation/widgets/show_filter_bottom_sheet.dart';
import 'package:logiology/features/product/presentation/widgets/side_drawer.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _productCard(final dynamic product, final BuildContext context) {
    return Card(
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: context.setResponsiveSize(3.5, 3.5),
                    fontWeight: FontWeight.bold,
                  ),
                ),
                SizedBox(height: context.setResponsiveSize(1, 1)),
                Text(
                  '\$${product.price}',
                  style: TextStyle(
                    fontSize: context.setResponsiveSize(3.8, 3.5),
                    color: AppColors.blueColor,
                  ),
                ),
                SizedBox(height: context.setResponsiveSize(1, 1)),
                Row(
                  children: [
                    Icon(
                      Icons.star,
                      size: context.setResponsiveSize(3.5, 3.5),
                      color: AppColors.amberColor,
                    ),
                    SizedBox(width: context.setResponsiveSize(1, 1)),
                    Text(
